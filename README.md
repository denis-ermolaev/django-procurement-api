...
Проект разрабатывается с применением агентного подхода: ИИ-агенты используются как исполнители для рутинной разработки, тестирования и исправления ошибок, а моя роль заключается в декомпозиции задач, формализации требований, проектировании бизнес-логики, управлении контекстом, проверке результата и контроле качества.
